make[1]: Entering directory `/scratch/prasadar/siracusa-fe/regression_tests/siracusa_power_tests/neureka_ki8_ko8_ho6_wo6_dw'
/usr/scratch/fenga5/beppe/INSTALL-PULP/bin/riscv32-unknown-elf-objdump -Mmarch=rv32imcxgap9 -d /scratch/prasadar/siracusa-fe/regression_tests/siracusa_power_tests/neureka_ki8_ko8_ho6_wo6_dw/build/ne16_test/ne16_test

/scratch/prasadar/siracusa-fe/regression_tests/siracusa_power_tests/neureka_ki8_ko8_ho6_wo6_dw/build/ne16_test/ne16_test:     file format elf32-littleriscv
...
1c008098:	61810113          	addi	sp,sp,1560 # 100006ac <cluster_stacks>
...
1c0080c8:	04412023          	sw	tp,64(sp) # 10200040 <__l2_shared_end+0x1ff990>
1c0080cc:	00312423          	sw	gp,8(sp)

1c0080d0 <loop>:
1c0080d0:	1a10a137          	lui	sp,0x1a10a
1c0080d4:	80010113          	addi	sp,sp,-2048 # 1a109800 <__l2_shared_end+0xa109150>
...
1c00817a:	0007aa23          	sw	zero,20(a5) # 201014 <__l1_heap_size+0x1f16c4>
...
1c0081aa:	03c7e683          	p.elw	a3,60(a5) # 20403c <__l1_heap_size+0x1f46ec>
...
1c0081ba:	02058593          	addi	a1,a1,32 # 201020 <__l1_heap_size+0x1f16d0>
...
1c0081d2:	20080413          	addi	s0,a6,512
1c0081d6:	0085a423          	sw	s0,8(a1)
1c0081da:	68080793          	addi	a5,a6,1664
1c0081de:	00f5a623          	sw	a5,12(a1)
1c0081e2:	6a080793          	addi	a5,a6,1696
1c0081e6:	00f5a823          	sw	a5,16(a1)
1c0081ea:	6a480793          	addi	a5,a6,1700
...
1c0081fc:	01878713          	addi	a4,a5,24 # 400018 <__l1_heap_size+0x3f06c8>
...
1c008224:	00062023          	sw	zero,0(a2) # 201000 <__l1_heap_size+0x1f16b0>
1c008228:	6705                	lui	a4,0x1
1c00822a:	002047b7          	lui	a5,0x204
1c00822e:	0631                	addi	a2,a2,12
1c008230:	c798                	sw	a4,8(a5)
1c008232:	03c7e683          	p.elw	a3,60(a5) # 20403c <__l1_heap_size+0x1f46ec>
...
1c008262:	68080a13          	addi	s4,a6,1664
...
1c0082e0:	d7078793          	addi	a5,a5,-656 # 1c000d70 <ne16_weights>
1c0082e4:	10800737          	lui	a4,0x10800
1c0082e8:	0106d0fb          	lp.setupi	x1,16,1c008302 <main+0x3a>
1c0082ec:	0007a803          	lw	a6,0(a5)
1c0082f0:	43c8                	lw	a0,4(a5)
1c0082f2:	478c                	lw	a1,8(a5)
1c0082f4:	47d0                	lw	a2,12(a5)
1c0082f6:	01072023          	sw	a6,0(a4) # 10800000 <__l2_shared_end+0x7ff950>
...
1c008330:	7da78793          	addi	a5,a5,2010 # 20c17da <__l1_heap_size+0x20b1e8a>
1c008334:	c31c                	sw	a5,0(a4)
1c008336:	05f68537          	lui	a0,0x5f68
1c00833a:	8082                	ret
1c00833c:	1a1007b7          	lui	a5,0x1a100
1c008340:	00878713          	addi	a4,a5,8 # 1a100008 <__l2_shared_end+0xa0ff958>
...
1c008358:	7da78793          	addi	a5,a5,2010 # 20c17da <__l1_heap_size+0x20b1e8a>
1c00835c:	c31c                	sw	a5,0(a4)
1c00835e:	05f68537          	lui	a0,0x5f68
1c008362:	8082                	ret
1c008364:	1a1007b7          	lui	a5,0x1a100
1c008368:	01878713          	addi	a4,a5,24 # 1a100018 <__l2_shared_end+0xa0ff968>
...
1c008380:	7da78793          	addi	a5,a5,2010 # 20c17da <__l1_heap_size+0x20b1e8a>
1c008384:	c31c                	sw	a5,0(a4)
1c008386:	05f68537          	lui	a0,0x5f68
1c00838a:	8082                	ret
1c00838c:	1a1007b7          	lui	a5,0x1a100
1c008390:	02878713          	addi	a4,a5,40 # 1a100028 <__l2_shared_end+0xa0ff978>
...
1c0083aa:	7da78793          	addi	a5,a5,2010 # 20c17da <__l1_heap_size+0x20b1e8a>
...
1c0083ce:	0387e703          	p.elw	a4,56(a5) # 204038 <__l1_heap_size+0x1f46e8>
1c0083d2:	a001                	j	1c0083d2 <pos_wait_forever+0x1a>
1c0083d4:	1a10a7b7          	lui	a5,0x1a10a
1c0083d8:	577d                	li	a4,-1
1c0083da:	80e7a423          	sw	a4,-2040(a5) # 1a109808 <__l2_shared_end+0xa109158>
...
1c0083fe:	00450693          	addi	a3,a0,4 # 5f68004 <__l1_heap_size+0x5f586b4>
...
1c008792:	02070713          	addi	a4,a4,32 # 1a104020 <__l2_shared_end+0xa103970>
...
1c0087c8:	0aa7a023          	sw	a0,160(a5) # 1a1040a0 <__l2_shared_end+0xa1039f0>
...
1c009058:	03068693          	addi	a3,a3,48 # 8000030 <__l1_heap_size+0x7ff06e0>
...
1c009826:	e8c58793          	addi	a5,a1,-372 # 1c000e8c <__l2_priv0_end>
...
1c00983a:	e7c50513          	addi	a0,a0,-388 # 1c000e7c <pos_alloc_l2>
...
1c009858:	e8050513          	addi	a0,a0,-384 # 1c000e80 <pos_alloc_l2+0x4>
1c00985c:	3789                	jal	1c00979e <pos_alloc_init>
1c00985e:	100005b7          	lui	a1,0x10000
1c009862:	40b2                	lw	ra,12(sp)
1c009864:	6b058793          	addi	a5,a1,1712 # 100006b0 <__l2_shared_end>
1c009868:	1c080637          	lui	a2,0x1c080
1c00986c:	1c001537          	lui	a0,0x1c001
1c009870:	8e1d                	sub	a2,a2,a5
1c009872:	6b058593          	addi	a1,a1,1712
1c009876:	e8450513          	addi	a0,a0,-380 # 1c000e84 <pos_alloc_l2+0x8>
...
1c009888:	e8c58593          	addi	a1,a1,-372
...
1c009896:	6b078793          	addi	a5,a5,1712 # 100006b0 <__l2_shared_end>
1c00989a:	95be                	add	a1,a1,a5
1c00989c:	1c0017b7          	lui	a5,0x1c001
1c0098a0:	050a                	slli	a0,a0,0x2
1c0098a2:	6641                	lui	a2,0x10
1c0098a4:	e7878793          	addi	a5,a5,-392 # 1c000e78 <pos_alloc_l1>
1c0098a8:	95060613          	addi	a2,a2,-1712 # f950 <__l1_heap_size>
...
1c0098b6:	e7878793          	addi	a5,a5,-392 # 1c000e78 <pos_alloc_l1>
...
1c0098ee:	80e7a423          	sw	a4,-2040(a5) # 1a109808 <__l2_shared_end+0xa109158>
...
1c00990a:	00478693          	addi	a3,a5,4 # 1a106004 <__l2_shared_end+0xa105954>
...
1c00997a:	20078793          	addi	a5,a5,512 # 204200 <__l1_heap_size+0x1f48b0>
1c00997e:	00e7a023          	sw	a4,0(a5)
1c009982:	00e7a623          	sw	a4,12(a5)
1c009986:	1c0017b7          	lui	a5,0x1c001
1c00998a:	e887a783          	lw	a5,-376(a5) # 1c000e88 <cluster_entry>
...
1c0099a2:	e6a72823          	sw	a0,-400(a4) # 1c000e70 <_edata>
1c0099a6:	e607aa23          	sw	zero,-396(a5) # 1c000e74 <cluster_running>
1c0099aa:	002047b7          	lui	a5,0x204
1c0099ae:	577d                	li	a4,-1
1c0099b0:	c3d8                	sw	a4,4(a5)
1c0099b2:	0387e703          	p.elw	a4,56(a5) # 204038 <__l1_heap_size+0x1f46e8>
...
1c0099c4:	e8b7a423          	sw	a1,-376(a5) # 1c000e88 <cluster_entry>
...
1c0099dc:	40070713          	addi	a4,a4,1024 # 201400 <__l1_heap_size+0x1f1ab0>
...
1c009a04:	20078793          	addi	a5,a5,512 # 204200 <__l1_heap_size+0x1f48b0>
...
1c009a92:	e7470713          	addi	a4,a4,-396 # 1c000e74 <cluster_running>
1c009a96:	431c                	lw	a5,0(a4)
1c009a98:	fffd                	bnez	a5,1c009a96 <cluster_wait+0x8>
1c009a9a:	1c0017b7          	lui	a5,0x1c001
1c009a9e:	e707a503          	lw	a0,-400(a5) # 1c000e70 <_edata>
1c009aa2:	8082                	ret
make[1]: Leaving directory `/scratch/prasadar/siracusa-fe/regression_tests/siracusa_power_tests/neureka_ki8_ko8_ho6_wo6_dw'
