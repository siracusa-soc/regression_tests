...
//L1_DATA int32_t O8_su[(OFM_CH * OUT_PIX)] = OFM_8_SU; // Golden model
	...
	L2_DATA uint8_t W8_su[(IFM_CH_NN * DIM_KER_NN * DIM_KER_NN * OFM_CH_NN)] = WEIGHTS_PULPNN_K;
	L2_DATA int8_t  X8_su[(OUT_PIX_NN * IFM_CH_NN * DIM_KER_NN  * DIM_KER_NN)] = IFM_PULPNN_K;
	L2_DATA int32_t Y8_su[(OFM_CH_NN * OUT_PIX_NN)] = {0};
	L2_DATA int32_t O8_su[(OFM_CH_NN * OUT_PIX_NN)] = OFM_PULPNN_K; // Golden model
